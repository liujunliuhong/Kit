...
+ (void)requestAuthorizetionWithType:(YHAuthorizetionType)type completion:(void(^_Nullable)(BOOL granted, BOOL isFirst))completion;
 ...
 */
+ (void)checkNotificationAuthorizationWithResultBlock:(void(^_Nullable)(YHNotificationAuthorizationType authorizationType))resultBlock NS_CLASS_AVAILABLE_IOS(8_0);
